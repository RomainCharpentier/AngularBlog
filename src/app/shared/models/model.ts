...
export abstract class Mapping<Raw> {
    static serialize<MappingConstructor extends new (model?: any) => any,
        ...
        Raw extends RawFromMapping<Mapping>>(this: MappingConstructor, model?: Model<Mapping>, options?: SerializationOptions): Raw | undefined {
        if (model === undefined) {
            return undefined;
        }
        // if (model === null) {
    ...
    static deserialize<MappingConstructor extends new (model?: any) => any,
        // tslint:disable-next-line:no-shadowed-variable
        Mapping extends InstanceType<MappingConstructor>,
        Raw extends RawFromMapping<Mapping>>(this: MappingConstructor, raw?: Raw): Mapping | undefined {
        if (raw === undefined) {
            return undefined;
        }
        // if (raw === null) {
